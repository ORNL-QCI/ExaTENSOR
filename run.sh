...
#CRAY specific:
export CRAY_OMP_CHECK_AFFINITY=TRUE                 #CRAY: shows thread placement (optional)
...
aprun -n $QF_NUM_PROCS -N $QF_PROCS_PER_NODE -d $QF_CORES_PER_PROC -cc 0,2,4,6,8,10,12,14,1,3,5,7,9,11,13,15 ./qforce.v13.01.x #> qforce.log
