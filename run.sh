...
export QF_AMDS_PER_PROCESS=0                        #optional
...
export MIC_KMP_PLACE_THREADS="56c,4t"               #optional
export MIC_KMP_AFFINITY="granularity=fine,compact"  #optional
export OFFLOAD_REPORT=2                             #optional
export KMP_AFFINITY=compact                         #optional
export MKL_NUM_THREADS=$OMP_NUM_THREADS             #optional
