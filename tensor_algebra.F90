...
!DIR$ ATTRIBUTES OFFLOAD:mic:: COPY_FF,COPY_FK,COPY_KF,COPY_KK,COPY_F,COPY_K,TRY_LATER,DEVICE_UNSUITABLE,TALSH_FAILURE
...
!DIR$ ATTRIBUTES ALIGN:128:: COPY_FF,COPY_FK,COPY_KF,COPY_KK,COPY_F,COPY_K,TRY_LATER,DEVICE_UNSUITABLE,TALSH_FAILURE
